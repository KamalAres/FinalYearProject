...
import finalyear.project.cse.comments.ConfigFile;
import finalyear.project.cse.comments.ImageLoader;
import finalyear.project.cse.database.Group;
import finalyear.project.cse.refresh.*;
import finalyear.project.cse.util.ClipboardUtil;
import finalyear.project.cse.util.Threads;

import java.io.IOException;
import java.util.HashMap;
import java.util.Map;

import static finalyear.project.cse.refresh.RefreshStyle.CUSTOM;
import static finalyear.project.cse.refresh.RefreshStyle.values;
