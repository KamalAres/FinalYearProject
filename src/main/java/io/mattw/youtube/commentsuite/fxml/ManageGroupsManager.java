...
import finalyear.project.cse.database.GroupItem;
import finalyear.project.cse.database.GroupStats;
import finalyear.project.cse.events.GroupItemAddEvent;
import finalyear.project.cse.events.GroupItemDeleteEvent;
import finalyear.project.cse.util.DateUtils;
import finalyear.project.cse.util.FXUtils;
...
//            likeDislikeRatio, normalizedRatio;
    @FXML private ListView<MGMVYouTubeObjectItem>  popularViewersList, activeViewersList;
    @FXML private GridPane commentStatPane, videoStatPane;

    @FXML private Accordion accordion;
    @FXML private TitledPane generalPane, viewerPane;
...
//            //videoPane.setDisable(true);
    ...
    public void cleanUp() {
        runLater(() -> {
            ...
            Stream.of(generalPane, viewerPane)
                    .forEach(pane -> pane.setDisable(true));
            Stream.of(popularViewersList, activeViewersList)
